function [W,b,optTheta] = linearDecoderExerciseDCT(patches,patchDim,numPatches)
...
displayColorNetworkDCT(patches(:, 1:100));
...
displayColorNetworkDCT( (W*ZCAWhite)');
