function result = mslUNIQUE_DCT(img1,img2)
%%
...
workspace = load('ImageNet_Weights_YGCr_DCT_1.mat');        
weight = workspace.W;  
bias = workspace.b;
...
img1_s = mslProcessUNIQUE_DCT(img1,weight,bias);
img2_s = mslProcessUNIQUE_DCT(img2,weight,bias);
...
%Pooling using 56th!!! power of Spearman Correlation coefficient
